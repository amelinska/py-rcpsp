...
#from pyrcpsp.SingleModeClasses import Activity
from pyrcpsp import ResourceUsage
...
class ResourceUsagesTest(unittest.TestCase):
    def test_update_resource_usages_in_time(self):
        ...
        activity1 = SingleModeClasses.Activity("a1",2,{1:2})
        point_in_time_1 = 1
        ResourceUsage.update_resource_usages_in_time(resource_usages_in_time, activity1, point_in_time_1)
